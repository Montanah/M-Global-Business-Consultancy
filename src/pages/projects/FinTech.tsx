          ...
          >
            ...
            <div className="prose prose-lg max-w-none mb-12">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                A comprehensive financial dashboard that empowers users with
                real-time analytics, portfolio tracking, and actionable
                investment insights. This platform transforms complex financial
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Designed with both novice and experienced investors in mind, the
                platform offers an intuitive interface that makes complex
                financial concepts accessible while providing the depth needed
