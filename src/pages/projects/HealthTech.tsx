          ...
          >
            ...
            <div className="prose prose-lg max-w-none mb-12">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                A revolutionary healthcare mobile application that bridges the
                gap between patients and healthcare providers across Africa.
                This innovative platform brings quality healthcare services to
                users' fingertips.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                This application democratizes access to healthcare, particularly
                benefiting underserved communities by connecting them with
                qualified medical professionals regardless of geographic
                barriers.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              <Button asChild size="lg">
                <a
                  href="https://healthtech-demo.com"
                  target="_blank"
